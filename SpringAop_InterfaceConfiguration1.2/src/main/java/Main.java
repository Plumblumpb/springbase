...
//        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:application-proxyFactoryBean.xml");
...
//    public static void main(String[] args) {
//        // 用我们的配置文件来启动一个 ApplicationContext
//        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:application-beanNameAutoProxyCreator.xml");
////        ApplicationContext context1 = new FileSystemXmlApplicationContext("D:application.xml");
////        ApplicationContext context2 = new AnnotationConfigApplicationContext("classpath:application.xml");
//        System.out.println("context 启动成功");
...
//    }
    ...
    public static void main(String[] args) {
        // 用我们的配置文件来启动一个 ApplicationContext
        ApplicationContext context = new ClassPathXmlApplicationContext("classpath:application-defaultAdvisorAutoProxyCreator.xml");
//        ApplicationContext context1 = new FileSystemXmlApplicationContext("D:application.xml");
//        ApplicationContext context2 = new AnnotationConfigApplicationContext("classpath:application.xml");
        System.out.println("context 启动成功");
        FoodService foodService = context.getBean(FoodService.class);
